...
Follow these steps to preview this documentation site locally.

<Steps>
<Step title="Install the docs CLI">
...
By default, the local preview uses port 3000. You can customize the port with the `--port` flag. For example, to run on port 3333, use this command:
...
Each CLI release is associated with a specific version of the underlying platform. If your local preview does not align with the production version, please update the CLI:
